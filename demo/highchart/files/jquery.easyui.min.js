...
_588.css("left",_587._outerWidth()+"px");
var hh;
_589.add(_58a).css("height","");
_58b.add(_58c).css("height", "");
var _58b_h = $(".datagrid-header-row").height() * _58b.find(".datagrid-header-row").length;
var _58c_h = $(".datagrid-header-row").height() * _58c.find(".datagrid-header-row").length;
hh = Math.max(_58b_h, _58c_h);
...
_587.add(_588).children("div.datagrid-body").css({ marginTop: _58e,  minHeight: (_591 ? _591 - _590 - _58f : ""), maxHeight: (_592 ? _592 - _590 - _58f : "") });

view.find("div.datagrid-body").css({ position: "absolute", top: _589._outerHeight() + "px", bottom: _587.children("div.datagrid-footer")._outerHeight() + "px"});
if ($(".datagrid-pager").length == 0) {
    view.css("bottom", "0");
}
else {
    view.css("bottom", $(".datagrid-pager").outerHeight() + "px");
}
if ($(".datagrid-toolbar").length == 0) {
    view.css("top", "0");
}
else {
    view.css("top", $(".datagrid-toolbar").outerHeight() + "px");
}
view.height("auto");
};
